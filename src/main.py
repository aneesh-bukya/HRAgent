...
researcher_agent = Agent(
        ...
        tools=[google_search],
        backstory=dedent("""\
          As a Research Specialist, your job to search the web and come up with the best practices and methods
...
crew = Crew(agents=[researcher_agent], tasks=[set_research_task])
# Get your crew to work!
result = crew.kickoff()
print("######################")
print(result)
...
# email_receiver = 'johncruders@gmail.com'
